...
urlpatterns = [
    ...
    path('export_t7/<int:year>', export_t7_all, name='export_t7_all'),
    ...
    path('department/<int:department_id>/export_t7/<int:year>', export_t7_department, name='export_t7_department'),
    ...
    path('department/<int:department_id>/add_employee/', EmployeeCreateView.as_view(), name='add_employee'),
